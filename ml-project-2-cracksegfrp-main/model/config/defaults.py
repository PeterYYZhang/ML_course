...
_C.MODEL.RECEPTIVE_ENLARGE = False
_C.MODEL.RE_METHOD = "msc"
_C.MODEL.SCE = False
_C.MODEL.RMP = False
_C.MODEL.RESIDUAL = False
_C.MODEL.GAMMA_HFE = 0.5


_C.SOLVER = CN()
_C.SOLVER.MAX_ITER = 100000
_C.SOLVER.TRAIN_DATASET_RATIO = 1.0
...
_C.SOLVER.SCE = False
_C.SOLVER.SCE_WEIGHT = 0.5

_C.INPUT = CN()
_C.INPUT.IMAGE_SIZE = [400, 400] # H x W
_C.INPUT.MEAN = [0.4741, 0.4937, 0.5048]
_C.INPUT.STD = [0.1621, 0.1532, 0.1523]

_C.DATASET = CN()
_C.DATASET.TRAIN_IMAGE_DIR = 'datasets/FRP/train/images'
_C.DATASET.TRAIN_MASK_DIR = 'datasets/FRP/train/masks'
_C.DATASET.TEST_IMAGE_DIR = 'datasets/FRP/test/images'
_C.DATASET.TEST_MASK_DIR = 'datasets/FRP/test/masks'
