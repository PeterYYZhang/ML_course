...
group0_x, group1_x, group2_x = \
        data_utils.group_poly(group0_x, group1_x, group2_x, degree_list = best_degrees, all_poly = True, add_log = add_log)

group0_x, group1_x, group2_x = data_utils.add_bias_group(group0_x, group1_x, group2_x, add_bias)
group_0_best_lambda = 3.3598182862837877e-10
...
group_1_best_lambda = 0.00020691380811147902
...
group_2_best_lambda = 5.455594781168514e-06
...
group0_x_test, group1_x_test, group2_x_test = \
        data_utils.group_poly(group0_x_test, group1_x_test, group2_x_test, degree_list = best_degrees, all_poly = True, add_log = add_log)
